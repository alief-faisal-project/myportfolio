      ...
      <div className="container-custom">
        ...
        <div className="max-w-3xl">
          <p className="text-lg md:text-xl leading-relaxed mb-6">
            ...
            digunakan. Saya menikmati proses mengubah desain menjadi tampilan
            yang bisa benar-benar dipakai oleh pengguna.
          </p>
          <p className="text-lg md:text-xl leading-relaxed mb-6">
            Saat ini saya terbiasa menggunakan React, TypeScript, dan Tailwind
            CSS, serta beberapa teknologi frontend lainnya. Saya masih terus
            belajar, bereksperimen, dan mengikuti perkembangan teknologi agar
            bisa berkembang lebih jauh.
          </p>
          <p className="text-lg md:text-xl leading-relaxed text-muted-foreground">
            Bagi saya, frontend development adalah tempat di mana logika dan
            kreativitas saling ketemu.
          </p>
        </div>
      </div>
    </section>
